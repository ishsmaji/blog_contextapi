...
const Pagination = () => {
  ...
  const{pages ,totalpages,handelPageChange }=useContext(Appcontext);
       ...
       <div className='flex items-center gap-x-3 w-11/12 max-w-2xl mx-auto'>
           {
            pages >1 &&
            (
              <button className='border-2 border-gray-300 py-1 px-4 rounded-md' onClick={()=> handelPageChange(pages-1)}>
                Previous
              </button>
            )
           }
